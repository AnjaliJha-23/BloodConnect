      ...
      <div className="row align-items-center">
        ...
        <motion.div
          ...
          <div
            ...
            🩸
            <span className="ms-2">Donate Blood, Save Lives</span>
          </div>
          ...
          <div className="d-flex gap-3 flex-wrap">
            <button
              className="btn btn-danger rounded-pill px-5 py-3 fw-semibold shadow"
        ...
        <motion.div
          ...
          <img
            ...
            style={{
              maxHeight: "520px",
              filter: "drop-shadow(0 18px 35px rgba(229,57,53,.20))",
            }}
          />
        </motion.div>
      </div>
